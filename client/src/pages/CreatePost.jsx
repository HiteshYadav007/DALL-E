...
const CreatePost = () => {
  ...
  return (
    ...
    <div>
        <h1 className="font-extrabold text-[#222328] text-[29px]">
          Create
        </h1>
        <p className="mt-2 text-[#666e75] text-[16px] max-w-full">
          Create imaginative and visually stunning
          images through DALL-E API and share them 
          with the community
        </p>
    </div>
    ...
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
            focus:ring-blue-500 focus:border-blue-500 w-64 h-64 p-3 flex justify-center items-center'>
              {form.photo ? (
                <img src={form.photo} alt={form.prompt} className='w-full h-full object-contain'/>
              ) : (
                <img src={preview} alt='preview' className='h-9/12 w-9/12 object-contain opactiy-40'/>
              ) }
        ...
        <div className="mt-10">
          ...
          you have created the image you can share it with others 
          in the community </p>
          <button
            type='submit'
